...
const article = {
  ...
  url: 'https://www.researchgate.net/publication/383378393_Customer_behavioural_content_recommendation_system_using_decision_tree_and_genetic_algorithm_for_online_shopping_websites',
};
